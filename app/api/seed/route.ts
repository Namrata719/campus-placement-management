...
export async function GET() {
    try {
        ...
        // Set activeResumeId to the first resume's _id (generated by MongoDB)
        if (student.resumes && student.resumes.length > 0) {
            student.activeResumeId = student.resumes[0]._id.toString()
            await student.save()
        }

        console.log("✓ Created Student with resume")
